...
def simulate_fit():
    ...
    left.page_link("pages/simulate.py", label="Simulate Model", icon=":material/laps:")
    right.page_link("pages/fit.py", label="Fit/Train Model", icon=":material/model_training:")
